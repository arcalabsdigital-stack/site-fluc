...
const faqs = [
  ...
  },
  {
    ...
    a: 'Você tem 14 dias grátis para testar todas as funcionalidades do Fluc. Não pedimos cartão de crédito no cadastro, assim você não corre o risco de ser cobrado acidentalmente.',
  },
]
